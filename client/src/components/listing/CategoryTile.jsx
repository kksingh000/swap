  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative block aspect-[4/5] overflow-hidden rounded-2xl border border-white/10 bg-charcoal shadow-material transition-all duration-300 hover:border-red/60 hover:shadow-glow"
      >
        <ImageFrame
          src={category.image}
          alt={category.name}
